...
%\iff
\def\revdots{\mathinner{\mkern1mu\raise1pt\vbox{\kern7pt\hbox{.}}\mkern2mu\raise4pt\hbox{.}\mkern2mu \raise7pt\hbox{.}\mkern1mu}}
...
\begin{definition}[Metric]
  A \emph{metric} is a function defined by
  \begin{align}
    d: M \times M \to \mathbb{R}
  \end{align}
  such that for any $x,y,z\in M$, the separation axiom
  \begin{align}
    d(x,y) \geq 0,
  \end{align}
  the indiscernible identity
  \begin{align}
    d(x,y) = 0 \iff x = y
  \end{align}
  the symmetry axiom
  ...
  \end{align}
  all hold. A \emph{metric space} is a set with a metric defined.
\end{definition}

\begin{definition}[Absolute Difference]
  The \emph{absolute difference} is a function $\mathbb{R}\times \mathbb{R}\to \mathbb{R}$
  \begin{align}
    d(x,y) := |x - y|
  \end{align}
\end{definition}
...
\begin{definition}[Euclidean Metric]
  \begin{align}
    d(x,y) := \sqrt{\sum_{i} d_i(x_i,y_i)^2}
  \end{align}
\end{definition}

\begin{definition}[Taxi-Cab Metric]
  \begin{align}
    d(x,y) := \sum_{i} d_i(x_i,y_i) 
  \end{align}
\end{definition}

\begin{definition}[Maximum Metric]
  \begin{align}
    d(x,y) := \max\{d_i(x_i,y_i) \}
  \end{align}
\end{definition}
...
\begin{definition}[Bounded Sequence]
  A sequence is \emph{bounded} if there is a $p\in M$ and $r\in\mathbb{R}$ , such that
  \begin{align}
    \forall n\in\mathbb{N}: d(s_n, p) \leq r
  \end{align}
\end{definition}

\begin{definition}[Pinched Sequence]
  A sequence is \emph{pinched} by $r\in\mathbb{R}$, if
  \begin{align}
    \forall m,n\in\mathbb{N}: d(s_m, s_n) \leq r
  \end{align}
\end{definition}

\begin{definition}
  A real sequence is \emph{bounded above} by $B$ if
  \begin{align}
    \forall n: s_n < B
  \end{align}
  and is \emph{bounded below} by $b$ if
  \begin{align}
    \forall n: b < s_n
  \end{align}
  A sequence is \emph{totally bounded} if it is bounded above and below.
\end{definition}

\begin{theorem}
  A real sequence is totally bounded, iff it is bounded.
\end{theorem}
\begin{proof}
  Let $s:\mathbb{N}\to \mathbb{R}$ be a totally bounded sequence
  \begin{align}
    \forall n\in\mathbb{N}:b< s_n < B
  \end{align}
  Let $p$ be the average of the two bounds
  \begin{align}
    p:= \frac{B+b}{2}
  \end{align}
  and $r$ be the distance from $B$ to $p$
  \begin{align}
    r:= B-p
  \end{align}
  Rearranging
  ...
  \begin{align*}
    ...
    |s_n-p| &< r
  \end{align*}
  Now assume that $\langle s_n \rangle$ is bounded, that is that there are $p,r\in\mathbb{R}$ such that 
  \begin{align*}
    |s_n - p| &< r\\
    p-r < s_n &< p+r
  \end{align*}
...
\begin{definition}[Convergent Sequence]
  A sequence $\langle s_n \rangle$ in $M$ \emph{converges} to $l\in M$, if
  \begin{align}
    \forall \varepsilon > 0: \exists N \in \mathbb{N}:\forall n>N: d(s_{n}, l)< \varepsilon
  \end{align}
\end{definition}
...
\end{theorem}
\begin{proof}
  Let $M= (A, d)$ be a metric space and 
  let $\langle s_n \rangle$ be a sequence in $M$ that converges to $l\in M$. Let $\varepsilon>0$. Since $\langle s_n \rangle$ converges, there is an $N$ such that if $n>N$
  \begin{align}
    d(s_n, l) < \varepsilon
  \end{align}
  Set $B'$ be a bound of the sequence before $N$
  \begin{align}
    B'&:= \max \{ d(s_n, l) : n\leq N \}\nonumber
  \end{align}
  Finally set
  \begin{align}
    B &:= \max \{ B', \varepsilon \}
  \end{align}
  Then $B$ is a bound for all $n\in\mathbb{N}$
  \begin{align}
    \forall n\in\mathbb{N}: d(s_n, l) \leq B
  \end{align}
  which implies that $\langle s_n \rangle$ is bounded.
\end{proof}
...
\end{theorem}
\begin{proof}
  Choose an $\varepsilon'>0$ and define $\varepsilon:= 2\varepsilon'$. 
  By the definition of convergence, there exists an $N_s$ and $N_t$ such that
  \begin{align}
    n > N_s \implies |s_n - S| < \varepsilon'\\
    n> N_t \implies |t_n - T| < \varepsilon'
  \end{align}
  Let $N:= \max \{ N_s, N_t\}$, then for $n>N$, by the triangle inequality
  \begin{align}
    |(s_n+t_n) - (S+T) | \leq |s_n - S| + |t_n - T|
  \end{align}
  By the definition of convergence
  \begin{align}
    |s_n - S | + |t_n - T| < \varepsilon ' + \varepsilon' = \frac{\varepsilon}{2} + \frac{\varepsilon}{2} = \varepsilon
  \end{align}
  Thus 
  \begin{align}
    \lim_n (s_n+t_n) = S+T
...
\begin{proof}
  ...
  \begin{align}
    ...
    n> N_t \implies |t_n - T| < \varepsilon'
  \end{align}
  Let $N:= \max \{ N_s, N_t\}$, then for $n>N$
  \begin{align}
  ...
  \begin{align}
    |s_n(t_n - T) + (s_n - S) T| &\leq |s_n (t_n - T) | + |(s_n - S) T|\nonumber\\
    &\leq |s_n| |t_n - T| + |s_n - S| |T|
  \end{align}
  Since every convergent sequence is also bounded, there is some bound $B$, such that for every $n$
  \begin{align}
    |s_n| < B
  \end{align}
  \begin{align}
    |s_n| |t_n - T| + |s_n - S| |T| \leq B |t_n - T| + |s_n - S| |T|
  \end{align}
  Let $M:= \max\{ C , |T| \}$.
  Then
  \begin{align}
    B |t_n - T| + |s_n - S| |T| \leq M (|s_n - S| + |t_n -T|)
  \end{align}
  Let $\varepsilon := 2M \varepsilon'$, then
  \begin{align}
    |s_n - S| < \varepsilon' = \frac{\varepsilon}{2M}\\
    |t_n - T| < \varepsilon' = \frac{\varepsilon}{2M}
  \end{align}
  Then
  \begin{align}
    M (|s_n - S| + |t_n -T|) < M \left(\frac{\varepsilon}{2M} + \frac{\varepsilon}{2M}\right) = \varepsilon
  \end{align}
  Thus, for $n> N$
  \begin{align}
    |s_nt_n - ST| < \varepsilon
  \end{align}
  or
  \begin{align}
    \lim_n s_n t_n = ST
