...
\begin{proof}
  ...
  \begin{align*}
    ...
    &= d(s_n \cdot t_n - T \cdot T, 0) && \text{(translation invariance)}\\
    ...
    &\leq d(s_n \cdot (t_n - T), 0)+d((s_n - S) \cdot T, 0) && \text{(triangle inequality)}\\
    &= d(s_n \cdot t_n , s_n \cdot T) +d(s_n \cdot T, S \cdot T) && \text{(translation invariance)}
  \end{align*}
